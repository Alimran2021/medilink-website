                ...
                <Col>
                    <Card style={{ width: '356px' }}>
                        ...
                        <Card.Body className="absolute bg-white py-8 px-4 top-52 left-4 w-80 shadow-md">
                            <div className="relative bottom-9 left-60 bg-pink-600 text-white w-10 h-10 p-2 rounded-full flex justify-center items-center text-2xl"><i className="fas fa-plus"></i></div>
                            <Card.Title className="font-normal">{serviceType}</Card.Title>
                            <Card.Text className="font-light">
                                {description}
                            </Card.Text>
                            <Link className="text-decoration-none text-black mr-8 hover:text-pink-600" to={`/service/${id}`}>
                                <span className="hover:text-pink-600 transition-opacity mr-3"> Read More</span>
